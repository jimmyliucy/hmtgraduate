    ...
    $.ajax({
        ...
        success: function (data) {
            if (data != null && data != '' && data != undefined) {
                sessionStorage.setItem('enum',JSON.stringify(data));
            } else {
                console.log(data);
            }
        },
...
function getEnumCacheByCode(keyCode, code) {
    var enumObject = sessionStorage.get("enum");
    if (enumObject == null || enumObject == '' || enumObject == undefined) {
        getEnumCache();
    }
    return null;
}

...
import com.hmt.graduate.paper.dao.RoleMapper;
import com.hmt.graduate.paper.dao.UserMapper;
import com.hmt.graduate.paper.dao.UserRoleMapper;
...
import com.hmt.graduate.paper.pojo.UserRoleKey;
...
public class UserServiceImpl implements UserService {
	...
	public String setUser(User user, String roleIds) {
		...
		if (user.getId() != null) {
			...
			//清空更新用户的redis权限缓存
			redisUtil.delete(paramProperties.getShiroRedisCachePrefix()+userId);

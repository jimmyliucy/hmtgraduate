package com.hmt.graduate.paper.entity.entity;

import java.io.Serializable;
import java.util.Date;

public class MmseDTO implements Serializable {

    private Integer id;

    private Integer mmsePatientId;
    ...
    public Integer getMmsePatientId() {
        return mmsePatientId;
    }

    public void setMmsePatientId(Integer mmsePatientId) {
        this.mmsePatientId = mmsePatientId;
    }

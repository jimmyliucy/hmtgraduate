...
CREATE TABLE `cam` (
  ...
  `acute` int(1) DEFAULT NULL,
  `attention` int(1) DEFAULT NULL,
  `thinking` int(1) DEFAULT NULL,
  `sence` int(1) DEFAULT NULL,
  `directional` int(1) DEFAULT NULL,
  `patient_id` int(11) DEFAULT NULL,
  `status` int(1) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `memory_loss` int(1) DEFAULT NULL,
  `perception_disorders` int(1) DEFAULT NULL,
  `psycho_sport_excitement` int(1) DEFAULT NULL,
  `mental_sport_slow` int(1) DEFAULT NULL,
  `wave` int(1) DEFAULT NULL,
  `sleep_wake_cycle` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `mmse_score` (
  ...
  `patient_id` int(11) DEFAULT NULL,
  `status` int(1) DEFAULT NULL,
  `question_thr` int(1) DEFAULT NULL,
  `question_two` int(1) DEFAULT NULL,
  `question_one` int(1) DEFAULT NULL,
  `crate_time` datetime DEFAULT NULL,
  `question_four` int(1) DEFAULT NULL,
  `question_five` int(1) DEFAULT NULL,
  `question_six` int(1) DEFAULT NULL,
  `question_sev` int(1) DEFAULT NULL,
  `question_eig` int(1) DEFAULT NULL,
  `question_nine` int(1) DEFAULT NULL,
  `question_ten` int(1) DEFAULT NULL,
  `question_tone` int(1) DEFAULT NULL,
  `question_ttwo` int(1) DEFAULT NULL,
  `question_tthr` int(1) DEFAULT NULL,
  `question_tfour` int(1) DEFAULT NULL,
  `question_tfive` int(1) DEFAULT NULL,
  `question_tsix` int(1) DEFAULT NULL,
  `question_tsev` int(1) DEFAULT NULL,
  `question_teig` int(1) DEFAULT NULL,
  `question_tnin` int(1) DEFAULT NULL,
  `question_wt` int(1) DEFAULT NULL,
  `question_wone` int(1) DEFAULT NULL,
  `coordinate` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `patients` (
  ...
  `family_disease` varchar(200) DEFAULT NULL,
  `symptom` varchar(200) DEFAULT NULL,
  `illness_time` date DEFAULT NULL,
  `degree` char(2) DEFAULT NULL,
  `phone_no` varchar(11) DEFAULT NULL,
  `hispital_no` varchar(20) DEFAULT NULL,
  `primary_diagnosis` varchar(300) DEFAULT NULL,
